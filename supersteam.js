...
//Am now able to write to local storage. If and switch statement issues, front-end.
	...
	function show_pricing_history(appid, type) {
		...
		//var userPrefs = window[userPrefs];
		//use for debug

		//var userPrefs = {"enableSearchResultsInfinteScroll":true,"hideAboutMenu":false,"hideInstallSteamButton":false,"highlightOwnedGames":false,"highlightWishlistGames":true,"ownedGamesColor":"#FF0000","priceComparisonRegions":[{"label":"Australia","value":"au"},{"label":"Brazil","value":"br"},{"label":"Canada","value":"ca"},{"label":"European Union","value":"eu1"},{"label":"European Union 2","value":"eu2"},{"label":"Indonesia","value":"id"},{"label":"Japan","value":"jp"},{"label":"Malaysia","value":"my"},{"label":"Mexico","value":"mx"}],"replaceSteamGreenlightBanner":true,"show3rdPartyDrmWarnings":true,"showAStatsLinks":true,"showAllAchievements":false,"showAppDescription":true,"showCompareLinks":false,"showExternalProfileLinks":true,"showHowLongToBeatInfo":true,"showMetaCriticScores":false,"showPcGamingWikiLinks":true,"showPriceHistory":true,"showRegionalPriceComparisons":true,"showSteamChartsInfo":true,"showSteamDbLinks":true,"showSteamRepStatus":true,"showSteamSpyInfo":true,"showTotalSpent":true,"showTransactionSummary":true,"showWidescreenInfo":true,"showXOriginTradingProhibited":false,"wishlistGamesColor":"#0000FF"};
		...
		.done(function (
			...
			switch (window.location.host) {
				...
				switch (true) {
					...
					add_badge_filter();
					//Server returns false for every GET request which results in an output of $0.00
						//the server is returning the right values now, but we need to memcache
